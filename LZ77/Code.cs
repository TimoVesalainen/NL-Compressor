...
namespace Nintenlord.Compressor.Compressions
{
    public unsafe class LZ77 : Compression
    {
        ...
        {
            return Nintenlord.Hacking.GBA.LZ77.Decompress(source, target);
        }
        ...
        {
            return Nintenlord.Hacking.GBA.LZ77.Compress(source, lenght);
        }
        ...
        {
            return Nintenlord.Hacking.GBA.LZ77.Scan(data, offset, length, sizeModulus, sizeMin, sizeMax);
        }
        ...
        {
            return Nintenlord.Hacking.GBA.LZ77.Scan(pointer, amount, sizeMultible, minSize, maxSize);
        }
        ...
        {
            return Nintenlord.Hacking.GBA.LZ77.GetCompressedDataLenght(source);
        }
